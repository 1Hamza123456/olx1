...
class BuyingOrder extends StatefulWidget {
  const BuyingOrder({Key? key}) : super(key: key);
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(
                                        width: 320,child:
                                        Text("Buy now any item that is eligible for delivery & recive it to your dorestep",textAlign: TextAlign.center,style: TextStyle(fontSize: 14,color: Color(0xffA5B4B5)),),),
